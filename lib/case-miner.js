...

{
  "document_info": {
    ...
    "endeavor_field": "<campo del endeavor propuesto>"
  },
  "issues": [
    {
      ...
      "extracted_quote": "<cita textual del documento que evidencia el issue>",
      "page_ref": "<página si se puede determinar o null>",
      "officer_reasoning": "<resumen del razonamiento del oficial>"
    }
  ],
  "requests": [
    {
      "request_text": "<qué evidencia específica pide USCIS>",
  ...
  "summary": {
    ...
    "strongest_concerns": ["<preocupación principal 1>"],
    "prongs_affected": {
      "P1": <true/false>,
      "P2": <true/false>,
      "P3": <true/false>
