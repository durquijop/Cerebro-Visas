/**
 * OCR Module v6 - Extrae texto de PDFs usando OpenAI GPT-4.1
...
export async function extractTextWithOCR(pdfBuffer) {
  ...
  console.log(`📤 Intentando extracción con GPT-4.1...`)
...
Solo devuelve el texto extraído:`
    ...
    if (!response.ok) {
      ...
      console.error(`❌ Error con GPT-4.1:`, response.status, errorText)
